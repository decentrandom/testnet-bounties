...
| 구분 | RAND 지급량 | 미션 |
|:---:|:---:|:---|
| 영문 버전 번역 | 100,000 RAND / 月 | <https://decentrandom.com>의 모든 컨텐트를 영어로 번역하는 작업입니다. 작업을 완료한 이에게 선착순 1인 지급합니다. |
| 일문 버전 번역 | 100,000 RAND / 月 | <https://decentrandom.com>의 모든 컨텐트를 일본어로 번역하는 작업입니다. 작업을 완료한 이에게 선착순 1인 지급합니다. |
| 백서 영문 버전 번역 | 400,000 RAND / 月 | DecentRandom 백서를 영어로 번역하는 작업입니다. 작업을 완료한 이에게 선착순 1인 지급합니다. |
| 백서 일문 버전 번역 | 400,000 RAND / 月 | DecentRandom 백서를 일본어로 번역하는 작업입니다. 작업을 완료한 이에게 선착순 1인 지급합니다. |
