# DecentRandom 테스트넷 IDO(Initial Dream Offering)
...
DecentRandom은 IDO를 통해 목표를 달성하고자 합니다.

멋대로 만든 IDO(Initial Dream Offering)은 투자금을 받는 대신, 참여한 만큼 미래를 약속합니다. 개발, 홍보, 의견 개진 등 프로젝트에 기여하는 이들에게 미래의 토큰을 보상합니다. 자본으로 토큰을 사는 것이 아니라, 희망과 꿈을 향한 행위에 반응하는 방식입니다.

따라서 투자금을 받지 않고 프로젝트에 직접 기여하는 이들에게 메인넷 런칭 이후 토큰을 지급합니다. 대상 수량은 제네시스 생성 토큰 전체입니다.

기존의 바운티 프로그램과 다를 바 없습니다. 전체 수량의 100%가 바운티로 제공된다는 점이 다를 뿐입니다.

## IDO 프로그램의 구분

| 구분 | RAND 지급량 | 내용 |
|:---:|:---:|:---|
| 프리(Pre-) IDO 프로그램 | 제네시스 생성량 중 10% | 초기 DecentRandom를 진행한 이들에게 제네시스 생성량 기준 10%를 분배합니다. |
| **테스트넷 IDO 프로그램** | **제네시스 생성량 중 60%** | 테스트넷에서 메인넷으로 진행할 수 있도록 개발, 운영, 홍보 등 다양한 방법으로 DecentRandom을 지원한 이들에게 메인넷 런칭 시 제네시스 생성량 중 60%를 분배합니다. |
| 메인넷 IDO 프로그램 | 제네시스 생성량 중 30% | 메인넷 런칭 이후 개발, 운영, 홍보 등 다양한 방법은 DecentRandom을 지원한 이들에게 제네시스 생성량 기준 30%를 분배합니다. |

현재는 테스트넷 IDO 프로그램이 준비 중 입니다.

## 테스트넷 IDO 프로그램 참여 안내

- 신청은 2019년 6월 1일부터 가능합니다.
- <https://decentrandom.com/ido> 페이지에서 신청하시기 바랍니다.
...
| 구분 | RAND 지급량 | 미션 |
|:---:|:---:|:---|
| 코어 개발 | 30,000,000 RAND | github.com/decentrandom/decentrandom 을 포크하여 가장 안전하고 효율적인 상태의 코어를 만드는 개발자에게 지급합니다. |
